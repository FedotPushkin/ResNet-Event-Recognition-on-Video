...
def parse_opts():
    ...
    parser.add_argument(
        '--root_path',
        default='I://UCF101',  #os.path.join( "I:", "UCF101"),
        type=str,
    ...
    parser.add_argument(
        ...
        default='ucf101',
        type=str,
        help='Used dataset ') #other DS TBD
    parser.add_argument(
        '--n_classes',
        default=10,
        type=int,
    ...
    parser.add_argument(
        '--batch_size', default=96, type=int, help='Batch Size')
    parser.add_argument(
        '--n_epochs',
        default=50,
        type=int,
    ...
    parser.add_argument(
        '--resume_path',
        default='I://UCF101//results//save_50.pth', #'resume/save_20.pth',
        type=str,
        help='Save data (.pth) of previous training')
    parser.add_argument(
        '--pretrain_path', default='I://UCF101//results//save_50.pth', type=str, help='Pretrained model (.pth)')
    parser.add_argument(
        '--ft_begin_index',
        default=0,
        type=int,
